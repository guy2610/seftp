...
The AES key is not generated by the client. It is generated by the server and delivered encrypted under the client's RSA public key. The client:

- receives encrypted AES material in response `1602` or `1605`
- decrypts it locally using `priv.key`
